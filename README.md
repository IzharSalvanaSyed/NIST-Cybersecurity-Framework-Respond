...
| Protect | To protect from future attacks, the network security team  implemented the following: New firewall rules that limit the rate of incoming ICMP packets. Verification of Source IP address in the firewall to check for spoofed IP addresses on incoming ICMP packets |
| Detect | --------------- |
| Respond | --------------- |
| Recover | --------------- |
